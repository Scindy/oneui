...
export const changeColor = ({ primary, primaryRGB, success, successRGB, danger, dangerRGB, warning, warningRGB, info, infoRGB }) => {
	if (primary) {
		newColor.primary = primary;
	}
	if (primaryRGB) {
		newColor.primary = primaryRGB;
	}
	if (success) {
		newColor.primary = success;
	}
	if (successRGB) {
		newColor.primary = successRGB;
	}
	if (danger) {
		newColor.primary = danger;
	}
	if (dangerRGB) {
		newColor.primary = dangerRGB;
	}
	if (warning) {
		newColor.primary = warning;
	}
	if (warningRGB) {
		newColor.primary = warningRGB;
	}
	if (info) {
		newColor.primary = info;
	}
	if (infoRGB) {
		newColor.primary = infoRGB;
	}
};
